...
<!-- Mirrored from coderthemes.com/Taych tel9a/blue-dark/apps-companies.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Oct 2018 08:48:03 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <?php include 'menu_prin.php'?>
            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a href="#">Taych tel9a</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/airbnb.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/apple.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/google.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/amazon.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/facebook.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/companies/cisco.png" alt="logo" class="thumb-lg rounded-circle mb-3">
                ...
                <footer class="footer">
                    2016 - 2018 © Taych tel9a <span class="hide-phone">- Coderthemes.com</span>
                </footer>
...
<!-- Mirrored from coderthemes.com/Taych tel9a/blue-dark/apps-companies.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Oct 2018 08:48:13 GMT -->
</html>