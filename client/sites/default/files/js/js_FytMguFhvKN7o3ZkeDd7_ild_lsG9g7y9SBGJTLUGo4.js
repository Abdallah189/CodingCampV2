...
(function ($) {$(document).ready(function() {
  ...
  //**************** Appear ******************************/
  /*$('#logo').appear(function() {
    $(this).addClass('animated').delay(5000).addClass('fadeInLefttBig');
  },{accX: 50, accY: 100});
  ...
  $( ".portfolio-item" ).each(function( index ) {
    $(this).appear(function() {
      ...
      if( (numRand % 2) == 0 ){
        $(this).addClass('animated').delay(500).addClass('fadeInRightBig');
      }else{
        $(this).addClass('animated').delay(500).addClass('fadeInLeftBig');
      }
  ...
  if( $.browser.androidChome || navigator.userAgent.match(/(iPad|iPhone|iPod touch);.*CPU.*OS 7_\d/i) ){
    ismobile = true;
  }
 ...
 if ($('body').hasClass('front')) {
  ...
  $(document).bind('vegaswalk',
    function(e, bg, step) {      
      $('.home-text > div').removeClass('fadeInUp');
      $('.home-text > div').addClass('hide');
      ...
      $('.slide-' + oldstep ).addClass('hide');
      $('.slide-' + oldstep).removeClass('fadeInUp');
