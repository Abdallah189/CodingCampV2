                                   ...
                                   echo" <div class=\"col-lg-4 col-md-6\">
                                    <div class=\"text-center card-box\">
                                        <div class=\"member-card\">
                                            ...
                                            <a href=\"super.php?id=" . $data["Cin_Client"]. "\"><button type=\"\" class=\"btn btn-danger btn-sm w-sm waves-effect m-t-10 waves-light\">Supprmer</button></a>
                                            
                                            <div class=\"text-left m-t-40\">
                                                <p class=\"text-muted font-13\"><strong>Full Name :</strong> <span class=\"m-l-15\">$b</span></p>
    
                                                <p class=\"text-muted font-13\"><strong>Mobile :</strong><span class=\"m-l-15\">(216) $d</span></p>
    
                                                <p class=\"text-muted font-13\"><strong>Coin :</strong> <span class=\"m-l-15\">$c</span></p>
